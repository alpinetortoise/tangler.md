...
Weaver separates documentation from source in a literate Markdown document.
The retention lexicon appears at the top of the file. Each declaration has the
form:

:: <<named-block>> ::

A declaration means that a matching named block is retained by `--weave`.
...
```text <<example>>
This example is retained by --weave.
```
